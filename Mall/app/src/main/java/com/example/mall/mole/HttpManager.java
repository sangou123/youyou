package com.example.mall.mole;

import android.util.Log;


import com.example.mall.common.Constants;
import com.example.mall.mole.api.Apicrevit;
...
public class HttpManager {
    ...
    Apicrevit mapicrevit;

    public Apicrevit gethomebenns(){
        if (mapicrevit==null){
          mapicrevit=  getRetrofit(Constants.homeapi).create(Apicrevit.class);
        }
        return mapicrevit;
    }
